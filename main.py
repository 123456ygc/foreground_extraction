...
def main():
    global frame
    video = "http://admin:admin@192.168.1.107:8081/"  # 此处@后的ipv4 地址需要修改为自己的地址
    ...
    while rval:
        ...
        # save_ygc
        #cv2.imwrite("C:\\Users\\22899\\Desktop\\VIBE_CSDN\\Camera_Road_01_output\\" + str(c) + r".jpg", segMat,[int(cv2.IMWRITE_PNG_STRATEGY)])
        k = cv2.waitKey(1)
        if k == 27:
            vc.release()
